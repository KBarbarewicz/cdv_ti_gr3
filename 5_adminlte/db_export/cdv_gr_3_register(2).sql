...
--
-- Host: 127.0.0.1
-- Czas generowania: 19 Maj 2023, 20:04
...
INSERT INTO `users` (`id`, `city_id`, `email`, `additional_email`, `firstName`, `lastName`, `birthday`, `password`, `created_at`) VALUES
(13, 2, 'jan@wp.pl', 'jan2@wp.pl', 'jan', 'wan', '2023-05-19', '$argon2id$v=19$m=65536,t=4,p=1$U2dFTzlNNFNCbGtZRmcvbQ$f9A1DQp2oPn1tr4dZDW9nmvu96r3botb5IzTSAmto4A', '2023-05-19 18:29:46');
